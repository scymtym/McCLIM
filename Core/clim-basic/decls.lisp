...
(defgeneric clime:sheet-icon (sheet)
...
(defgeneric (setf clime:sheet-icon) (new-value sheet)
...
(defgeneric clime:frame-icon (frame)
...
recognizable."))
(defgeneric (setf clime:frame-icon) (new-value frame)
...
(defgeneric clime:note-frame-icon-changed (frame-manager frame new-icon)
  (:documentation "McMCLIM extension: Notify client that the pretty
name of FRAME, managed by FRAME-MANAGER, changed to NEW-NAME.
FRAME-MANAGER can be NIL if FRAME is not owned by a frame manager at
the time of the change.")
