      ...
      (horizontally ()
        (labelling (:label "Demos")
          (vertically (:equalize-width t)
            ...
            (make-demo-button "Method Browser" 'clim-demo.method-browser:method-browser)
            ...
            (make-demo-button "Selection (clipboard)" 'clim-demo.selection-demo:selection-demo)
        ...
        (labelling (:label "Tests")
          (vertically (:equalize-width t)
            ...
            (make-demo-button "Accepting Values Test"  'clim-demo.accepting-values:av-test)
            (make-demo-button "Frame Icon and Name Test" 'clim-demo.names-and-icons:frame-sheet-name-test)
            (make-demo-button "Tracking Pointer test" 'clim-demo.tracking-pointer:tracking-pointer)))
        (labelling (:label "Regression Tests")
          (vertically (:equalize-width t)
            ...
            (make-demo-button "Flipping ink" 'clim-demo.flipping-ink:flipping-ink)
            (make-demo-button "Overlapping patterns" 'clim-demo.patterns-overlap:patterns-overlap)
