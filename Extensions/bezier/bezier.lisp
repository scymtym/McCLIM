...
;;; Compute the distance between a point and a vector represented as a
;;; complex number.
(defun dist (v z)
...
(clim-sys:defmethod* (setf output-record-position) :around
  ...
  (climi::with-standard-rectangle* (x1 y1) record
    (let ((dx (- nx x1))
          (dy (- ny y1)))
...
(defclass bezier-area (area
                       bezier-design
                       segments-mixin
                       bounding-rectangle-mixin)
  ())
...
(defmethod medium-draw-bezier-design*
    ((medium null-medium) (design bezier-curve))
  nil)
(defmethod medium-draw-bezier-design*
    ((medium null-medium) (design bezier-area))
  nil)
(defmethod medium-draw-bezier-design*
    ((medium null-medium) (design bezier-union))
  nil)
(defmethod medium-draw-bezier-design*
    ((medium null-medium) (design bezier-difference))
  nil)
